...
before = cv2.imread(pth + '/skan-000.png')
...
after = cv2.imread('wzory/wzor-skan-000.png')
...
cv2.imwrite("bufor_mask.png", thresh)
...
cv2.imwrite("testdiff1.png", mask)
